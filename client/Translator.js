...
export default class Translator extends Component {
  ...
  render() {
    TranslatorConfiguration.setConfig(
      ...
      "AIzaSyA_R3BSfvQ5a5gOlVaYpVFAe6lDV4yM2-c",
      "fr"
    );

    const translator = TranslatorFactory.createTranslator();
    translator.translate("hello world").then((translated) => {
      console.log("this is the translated function", translated);
    });
    ...
    translator
      ...
      .then((translated) => {
        this.setState({ output: translated });
        console.log(translated);
      })
      .catch((err) => console.error(err));

    console.log("I have logged here after translator");
